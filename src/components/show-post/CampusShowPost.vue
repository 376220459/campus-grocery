 ...
 * @LastEditTime: 2022-08-19 16:58:48
 * @FilePath: \campus-grocery\src\components\show-post\CampusShowPost.vue
 * @Description: 展示校园趣闻轶事帖子组件
-->
<template>
  <div
    v-if="postTelNumber"
    class="campus-show-post"
  >
    <header>
...
export default {
  ...
  async created() {
    ...
    resHandle(res, {
      successHandle: () => {
        ;[this.postTelNumber, this.title, this.postTime, this.content, this.browseCount, this.imgs] = [
          postData.telNumber,
          postData.title,
          postData.postTime,
          postData.content,
